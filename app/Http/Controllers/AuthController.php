...
class AuthController extends Controller
{
    ...
    // Cek role dari request URL
        ...
        if ($user->role_id == 1) {
            ...
            return redirect()->route('dashboard')->with('success', 'Anda Berhasil Login sebagai Guru');
        } elseif ($user->role_id == 4) {
            return redirect()->route('siswa.beranda')->with('success', 'Anda Berhasil Login sebagai Siswa');
        } else {
            Auth::logout();
