        ...
        <div class="form-container">
            ...
            <form method="POST" action="{{ route('register.data.store', ['role' => request('role')]) }}">
                ...
                <div class="input-group">
                    ...
                    <input type="text" id="full-name" name="nama" placeholder="Nama Lengkap" required />
                ...
                <div class="input-group">
                    ...
                    <input type="tel" id="phone-number" name="no_hp" placeholder="Nomor Handphone" required />
