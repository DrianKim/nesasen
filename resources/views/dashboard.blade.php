            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="mr-2 col">
                        ...
                        <p class="mb-1"><i class="text-gray-500 fas fa-map-marker-alt fa-sm fa-fw"></i> Jl. Arief Rahman Hakim No.35, Subang</p>
                ...
                <div class="mb-4 col-xl-4 col-md-4">
                    <div class="py-2 shadow card border-left-success h-100">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="mr-2 col">
                                    <div class="mb-1 text-xs font-weight-bold text-success text-uppercase">Total Murid</div>
                ...
                <div class="mb-4 col-xl-4 col-md-4">
                    <div class="py-2 shadow card border-left-warning h-100">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="mr-2 col">
                                    <div class="mb-1 text-xs font-weight-bold text-warning text-uppercase">Total Wali Kelas</div>
                ...
                <div class="mb-4 col-xl-6 col-md-6">
                    <div class="py-2 shadow card border-left-success h-100">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="mr-2 col">
                                    <div class="mb-1 text-xs font-weight-bold text-success text-uppercase">Kelas yang Diajar</div>
                ...
                <div class="mb-4 col-xl-6 col-md-6">
                    <div class="py-2 shadow card border-left-info h-100">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="mr-2 col">
                                    <div class="mb-1 text-xs font-weight-bold text-info text-uppercase">Wali Kelas</div>
        ...
        <div class="mb-4 col-xl-6 col-md-6">
            <div class="py-2 shadow card border-left-warning h-100">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="mr-2 col">
                            <div class="mb-1 text-xs font-weight-bold text-warning text-uppercase">Tugas yang Harus Dikerjakan</div>
                            <div class="mt-3">
                                <div class="mb-2">
                                    <div class="font-weight-bold">Tugas Matematika - Bab 4</div>
                                    <div class="small"><span class="text-gray-600">Guru: Ibu Siti</span> - <span class="text-danger">Due: 15 Apr 2025</span></div>
                                </div>
                                <div class="mb-2">
        ...
        <div class="mb-4 shadow card">
            ...
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <p class="mb-1">Jadwal UTS sudah tersedia. Silahkan cek di menu Pengumuman untuk info lebih lanjut.</p>
                ...
                <div class="mb-3">
                    ...
                    <p class="mb-1">Sekolah akan libur pada tanggal 17 April 2025 dalam rangka Hari Besar Nasional.</p>
