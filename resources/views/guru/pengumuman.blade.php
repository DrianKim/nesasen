...
<body class="with-right-section">
    <div class="container">
        ...
        <!-- Main Content -->
        <main>
            <h2 class="section-title-form">Buat Pengumuman Untuk siswa</h2>

            <div class="feature-card-pengumuman pengumuman-flex">
                <!-- Bagian kiri: vector -->
                <div class="vector-container">
                    <img src="{{ asset('img/guru-vector.png') }}" alt="Vector" />
                </div>

                <!-- Bagian kanan: form -->
                <div class="form-container">
                    <form action="{{ route('guru.pengumuman.store') }}" method="POST" class="form-pengumuman">
                        @csrf
                        ...
                        <div class="form-group-pengumuman">
            ...
            @once
                @include('guru.modal.edit-pengumuman')
            @endonce
        ...
        function openEditModal(id) {
            fetch(`/guru/pengumuman/${id}/edit`)
                ...
                .then(data => {
                    ...
                    form.action = `/guru/pengumuman/${id}`;
                    form.dataset.id = id;
