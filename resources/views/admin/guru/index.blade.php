...
@section('content')
    <div class="content-wrapper">
        <h2 class="table-title">Data Guru SMKN 1 Subang</h2>
                ...
                <div class="filter-wrapper">
                    <div class="filter-top">
                        ...
                        <div class="right-actions">
                            ...
                            <button class="btn-import" onclick="openModalImport('modalGuruImport')">
                                <span class="material-icons-sharp">file_present</span>
                            </button>
                            <button class="btn-export-1" onclick="openModalExport('modalGuruExport')">
    ...
    @if ($errors->any() && old('from_edit_guru'))
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                openModal('modalGuruEdit{{ old('from_edit_guru') }}');
            });
        </script>
    @elseif ($errors->any() && old('from_tambah_guru'))
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                openModal('modalGuruTambah');
            });
        </script>
    @endif
    ...
    <script>
        document.getElementById('formTambahGuru').addEventListener('submit', function() {
            document.getElementById('btnTambahGuru').disabled = true;
            document.getElementById('spinnerTambahGuru').style.display = 'inline-block';
            document.getElementById('textBtnTambahGuru').textContent = 'Menyimpan...';
        });

        document.getElementById('formImportGuru').addEventListener('submit', function() {
            document.getElementById('btnImportGuru').disabled = true;
            document.getElementById('spinnerImportGuru').style.display = 'inline-block';
            document.getElementById('textBtnImportGuru').textContent = 'Mengimport...';
        });
    </script>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function loadData() {
                ...
                currentRequest.open('GET', '{{ route('admin_guru.filter') }}?' + filterData.toString(), true);
