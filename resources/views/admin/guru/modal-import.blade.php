<!-- Modal Import Guru -->
<div class="modal fade" id="modalGuruImport" tabindex="-1" role="dialog" aria-labelledby="modalGuruImportLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="text-white modal-header bg-success">
                <h5 class="modal-title" id="modalGuruImportLabel">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <!-- Right side - Content -->
                    <div class="col-md-8">
                        <p class="mb-4">Disarankan untuk melakukan impor data dengan format sebagai berikut
                        </p>
                        ...
                        <div class="mb-4">
                            <a href="{{ route('admin_guru.template') }}" class="btn btn-outline-primary btn-sm">
                        ...
                        <div class="mb-3 alert alert-warning alert-sm">
                            ...
                            <small>Jika format tanggal lahir tidak sesuai maka data guru tidak dapat diimpor.</small>
                        </div>

                        <div class="mb-4 alert alert-info alert-sm">
                            <i class="fas fa-key me-2"></i>
                            <strong>Guru dapat langsung login menggunakan username dan password* dan wajib membuat
                                password baru</strong><br>
                            <small>*Password sementara guru adalah tanggal lahir dengan format ddmmyyyy</small>
                        </div>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" form="formImportGuru" class="btn btn-success" id="btnImport">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        Swal.fire({
                            icon: 'success',
                            title: 'Berhasil!',
                            text: data.message || 'Data guru berhasil diimpor',
                            showConfirmButton: false,
                            timer: 2000
                        });

                        // Close modal and reload page
                        $('#modalGuruImport').modal('hide');
                        setTimeout(() => {
                            location.reload();
                        }, 2000);
        ...
        $('#modalGuruImport').on('hidden.bs.modal', function() {
            importForm.reset();
