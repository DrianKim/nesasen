<div class="custom-modal" id="modalGuruExport">
    <div class="custom-modal-content">
            ...
            <div class="modal-flex">
                ...
                <div class="export-options">
                    ...
                    <div class="export-buttons">
                        <a href="{{ route('admin_guru.export.pdf') }}" class="btn-export pdf">
                            <span class="material-icons-sharp">picture_as_pdf</span> .pdf
                        </a>
                        <a href="{{ route('admin_guru.export.xlsx') }}" class="btn-export excel">
        ...
        <div class="custom-modal-footer">
            <button class="btn-secondary" onclick="closeModalExport('modalGuruExport')">
