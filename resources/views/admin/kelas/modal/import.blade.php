<div class="custom-modal" id="modalKelasImport">
    <div class="custom-modal-content">
        <div class="custom-modal-header bg-success">
            <h5>
                <span class="material-icons-sharp">upload_file</span> Impor Data Kelas
            </h5>
        </div>
        ...
        <div class="custom-modal-body">
            <div class="modal-flex">
                ...
                <div class="import-info">
                    ...
                    <!-- Tombol Download -->
                    <a href="{{ route('admin_kelas.template') }}" class="btn-outline btn-sm">
                    ...
                    <div class="alert info">
                        ...
                        Nama guru wali kelas opsional, tapi harus sesuai sistem.
                    </div>
        ...
        <div class="custom-modal-footer">
            <button class="btn-secondary" onclick="closeModalImport('modalKelasImport')">
                <span class="material-icons-sharp">close</span> Batal
            </button>

            <button class="btn-success" type="submit" form="formImportKelas" id="btnImportKelas">
                <span class="spinner" id="spinnerImportKelas" style="display: none; margin-right: 5px;"></span>
                <span class="material-icons-sharp">upload_file</span> <span id="textBtnImportKelas">Import</span>
            </button>
        </div>
    </div>
</div>
...
<script>
    document.getElementById('formImportKelas').addEventListener('submit', function(e) {
        e.preventDefault();
        ...
        btn.disabled = true;
        btn.innerHTML =
            `<span class="spinner" id="spinnerImportKelas" style="display: none; margin-right: 5px;"></span> <span class="material-icons-sharp">upload_file</span> <span id="textBtnImportKelas">Import</span>`;

        fetch("{{ route('admin_kelas.import') }}", {
                method: "POST",
                body: formData,
                headers: {
