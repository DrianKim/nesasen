<div class="custom-modal" id="modalKelasExport">
    <div class="custom-modal-content">
        <div class="custom-modal-header bg-success">
            <h5>
                <span class="material-icons-sharp">file_present</span> Export Data Kelas
            </h5>
        </div>
            ...
            <div class="modal-flex">
                ...
                <div class="export-options">
                    ...
                    <div class="export-buttons">
                        <a href="{{ route('admin_kelas.export.pdf') }}" class="btn-export pdf">
                            <span class="material-icons-sharp">picture_as_pdf</span> .pdf
                        </a>
                        <a href="{{ route('admin_kelas.export.xlsx') }}" class="btn-export excel">
        ...
        <div class="custom-modal-footer">
            <button class="btn-secondary" onclick="closeModalExport('modalKelasExport')">
