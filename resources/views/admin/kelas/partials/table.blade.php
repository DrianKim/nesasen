<table class="table table-hover">
    <thead>
        <tr>
            ...
            <th width="15%" class="sortable" data-column="Nama Kelas">Kelas<i
                    class="fas fa-sort"></i></th>
            <th width="30%" class="sortable" data-column="No. HP">Wali Kelas<i
                    class="fas fa-sort"></i></th>
            <th width="15%" class="sortable" data-column="Kelas">Jumlah Siswa<i
                    class="fas fa-sort"></i></th>
            ...
            <tr>
                <td colspan="7" class="py-4 text-center">
                    <div class="empty-state">
                        ...
                        <a href="{{ route('admin_kelas.create') }}"
                            class="btn btn-primary btn-sm">
                            <i class="mr-1 fas fa-plus"></i> Tambah Kelas
                        </a>
                    </div>
                </td>
            </tr>
