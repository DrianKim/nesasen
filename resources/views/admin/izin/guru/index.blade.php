...
@section('content')
    <div class="content-wrapper">
        <h2 class="table-title">Data Izin Guru SMKN 1 Subang</h2>
                ...
                <div class="filter-wrapper">
                    <div class="filter-top">
                        ...
                        <div class="right-actions">
                            ...
                            @include('admin.izin.guru.modal.export')
                            ...
                            <button class="btn-export-1" onclick="openModalExport('modalizinGuruExport')">
    ...
    <script>
        function openModalExport() {
            const modal = document.getElementById("modalizinGuruExport");
            if (modal) {
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function loadData() {
                ...
                console.log('Filter data:', filterData.toString()); // Debug log

                // Create AJAX request
                currentRequest = new XMLHttpRequest();
                currentRequest.open('GET', '{{ route('admin_izin_guru.filter') }}?' + filterData
                    .toString(),
                    true);
