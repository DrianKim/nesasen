<div class="custom-modal" id="modalizinGuruExport">
    <div class="custom-modal-content">
        ...
        <div class="custom-modal-footer">
            <button class="btn-secondary" onclick="closeModalExport('modalizinGuruExport')">
...
<script>
    function exportData(type) {
        ...
        const route = type === 'pdf' ?
            '{{ route('admin_izin_guru.export.pdf') }}' :
            '{{ route('admin_izin_guru.export.xlsx') }}';
