        ...
        <div class="skul-container">
            ...
            <div class="content-section">
                <div class="section-header">
                    <h2>Data Presensi Guru SMKN 1 Subang</h2>
                    <div class="action-buttons">
                        <a href="{{ route('admin_presensi_guru.create') }}" class="btn btn-primary btn-circle">
                ...
                <div class="filter-section">
                    <form id="presensi_guruFilterForm">
                        @csrf
                        <div class="row">
                            <!-- Left side filters -->
                            <div class="col-md-6">
                ...
                <div class="table-responsive">
                    <form id="bulk_form" action="{{ route('admin_presensi_guru.bulk_action') }}" method="POST">
                        @csrf
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function loadData() {
                ...
                currentRequest.open('GET', '{{ route('admin_presensi_guru.filter') }}?' + new URLSearchParams(formData)
                    .toString(), true);
        ...
        $(document).ready(function() {
            $('#formGuru').on('submit', function(e) {
                ...
                $.ajax({
                    url: "{{ route('admin_presensi_guru.store') }}", // route store
                    method: 'POST',
