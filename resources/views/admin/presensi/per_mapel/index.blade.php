...
@section('content')
        ...
        <div class="skul-container">
            ...
            <div class="content-section">
                <div class="section-header">
                    <h2>Data Presensi Per Mapel SMKN 1 Subang</h2>
                    <div class="action-buttons">
                        <a href="{{ route('admin_presensi_per_mapel.create') }}" class="btn btn-primary btn-circle">
                ...
                <div class="filter-section">
                    <form id="presensi_per_mapelFilterForm">
                        @csrf
                        <div class="row">
                            <!-- Left side filters -->
                            <div class="col-md-6">
                                    ...
                                    <div class="col-md-8">
                                        {{-- <div class="form-group search-box">
                                            ...
                                            <div class="input-group">
                                                ...
                                                placeholder="Cari per_mapel..." value="{{ request('search') }}">
                ...
                <div class="table-responsive">
                    <form id="bulk_form" action="{{ route('admin_presensi_per_mapel.bulk_action') }}" method="POST">
                        @csrf
                        <input type="hidden" name="bulk_action" id="bulk_action" value="">

                        <div id="table-container">
                            <!-- Konten tabel akan diisi dengan AJAX -->
                            @include('admin.presensi.per_mapel.partials.table')
                            <div class="mt-2 d-flex justify-content-end">
                                {{-- {{ $presensi_per_mapel->links() }}   --}}
                            </div>
                        </div>
                    </form>
                </div>
                ...
                <div class="pagination-section" id="pagination-container">
                    ...
                    @include('admin.presensi.per_mapel.partials.pagination')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            // Variables
            const filterForm = document.getElementById('presensi_per_mapelFilterForm');
        ...
        function bulkAction(action) {
            const checkedBoxes = document.querySelectorAll('input[name="selected_per_mapel[]"]:checked');
            if (checkedBoxes.length === 0) {
                alert('Silahkan pilih per_mapel terlebih dahulu');
                return;
            }

            if (action === 'delete' && !confirm('Anda yakin ingin menghapus per_mapel yang dipilih?')) {
                return;
            }
        ...
        function toggleAll(source) {
            const checkboxes = document.querySelectorAll('input[name="selected_per_mapel[]"]');
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function handleSaveButtonClick(button) {
                ...
                fetch(`/admin/per_mapel/inline-update/${id}`, {
                        method: "POST",
                        headers: {
            ...
            <button type="button" class="btn btn-sm btn-outline-danger" data-toggle="modal"
                data-target="#modalPer MapelDestroy${id}">
        ...
        $(document).ready(function() {
            $('#formPer Mapel').on('submit', function(e) {
                e.preventDefault();

                $.ajax({
                    url: "{{ route('admin_presensi_per_mapel.store') }}", // route store
                    method: 'POST',
                    data: $(this).serialize(), // Serialize form data
                    success: function(response) {
                        alert('Per Mapel berhasil ditambahkan!');
                        $('#modalPer MapelCreate').modal('hide');
