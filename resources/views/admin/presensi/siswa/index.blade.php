            ...
            <div class="content-section">
                <div class="section-header">
                    ...
                    <div class="action-buttons">
                        <a href="{{ route('admin_presensi_siswa.create') }}" class="btn btn-primary btn-circle">
                ...
                <div class="filter-section">
                    <form id="presensi_siswaFilterForm">
                        @csrf
                        <div class="row">
                            {{-- <div class="col-md-3">
                                    ...
                                    <select class="form-select" id="kelas" name="kelas">
                                        ...
                                        @foreach ($kelasFilter as $kelas)
                                            <option value="{{ $kelas->id }}"
                                                ...
                                                {{ $kelas->tingkat }} {{ $kelas->presensi_siswa->kode_presensi_siswa }}
                                                {{ $kelas->no_kelas }}
                                            </option>
                                        @endforeach
                                    </select>
                ...
                <div class="table-responsive">
                    <form id="bulk_form" action="{{ route('admin_presensi_siswa.bulk_action') }}" method="POST">
                        @csrf
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function loadData() {
                ...
                currentRequest.open('GET', '{{ route('admin_presensi_siswa.filter') }}?' + new URLSearchParams(
                        formData)
                    .toString(), true);
        ...
        function bulkAction(action) {
            const checkedBoxes = document.querySelectorAll('input[name="selected_presensi_siswa[]"]:checked');
            if (checkedBoxes.length === 0) {
                alert('Silahkan pilih presensi_siswa terlebih dahulu');
                return;
            }

            if (action === 'delete' && !confirm('Anda yakin ingin menghapus presensi_siswa yang dipilih?')) {
                return;
            }
        ...
        function toggleAll(source) {
            const checkboxes = document.querySelectorAll('input[name="selected_presensi_siswa[]"]');
