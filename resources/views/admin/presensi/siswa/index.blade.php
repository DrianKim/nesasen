        ...
        <div class="skul-container">
            ...
            <div class="content-section">
                <div class="section-header">
                    <h2>Data Presensi Siswa SMKN 1 Subang</h2>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="lihatBerdasarkan">Lihat Berdasarkan:</label>
                                            <select class="form-select" id="lihatBerdasarkan" name="filter_by">
                                                <option value="kelas"
                                                    {{ request('filter_by') == 'kelas' ? 'selected' : '' }}>Kelas</option>
                                                <option value="tanggal"
                                                    {{ request('filter_by') == 'tanggal' ? 'selected' : '' }}>Tanggal
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    {{-- Kelas Dropdown --}}
                                    <div class="col-md-6" id="filterKelas" style="display: none;">
                                        <div class="form-group">
                                    ...
                                    {{-- Tanggal Input --}}
                                    {{-- <div class="col-md-6" id="filterTanggal" style="display: none;">
                                        <div class="form-group">
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#formSiswa').on('submit', function(e) {
                ...
                $.ajax({
                    url: "{{ route('admin_presensi_siswa.store') }}", // route store
                    method: 'POST',
