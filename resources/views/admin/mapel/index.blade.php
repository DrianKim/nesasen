...
@section('content')
    ...
    <script>
        function openModal() {
            const modal = document.getElementById("modalMapelTambah");
            if (modal) {
        ...
        function openModalImport() {
            const modal = document.getElementById("modalMapelImport");
            if (modal) {
        ...
        function openModalExport() {
            const modal = document.getElementById("modalMapelExport");
            if (modal) {
                modal.style.display = 'flex';
                setTimeout(() => {
                    modal.classList.add('show')
