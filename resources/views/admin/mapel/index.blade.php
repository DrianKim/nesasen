...
@section('content')
    ...
    <div class="content-wrapper">
        <h2 class="table-title">Data Mapel SMKN 1 Subang</h2>
                ...
                <div class="filter-wrapper">
                    <div class="filter-top">
                        ...
                        <div class="right-actions">
                            ...
                            <button class="btn-import" onclick="openModalImport('modalMapelImport')">
                                <span class="material-icons-sharp">file_present</span>
                            </button>
                            <button class="btn-export-1" onclick="openModalExport('modalMapelExport')">
    ...
    @if ($errors->any() && old('from_edit_mapel'))
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                openModal('modalMapelEdit{{ old('from_edit') }}');
            });
        </script>
    @elseif ($errors->any() && old('from_tambah_mapel'))
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                openModal('modalMapelTambah');
            });
        </script>
    @endif
    ...
    @foreach ($mapel as $item)
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                setupEditFormListenersMapel({{ $item->id }});
            });
        </script>
    @endforeach

    <script>
        document.getElementById('formTambahMapel').addEventListener('submit', function() {
            document.getElementById('btnTambahMapel').disabled = true;
            document.getElementById('spinnerTambahMapel').style.display = 'inline-block';
            document.getElementById('textBtnTambahMapel').textContent = 'Menyimpan...';
        });

        document.getElementById('formImportMapel').addEventListener('submit', function() {
            document.getElementById('btnImportMapel').disabled = true;
            document.getElementById('spinnerImportMapel').style.display = 'inline-block';
            document.getElementById('textBtnImportMapel').textContent = 'Mengimport...';
        });

        function setupEditFormListenersMapel(id) {
            const form = document.getElementById('formEditMapel' + id);
            const btn = document.getElementById('btnEditMapel' + id);
            const spinner = document.getElementById('spinnerEditMapel' + id);
            const text = document.getElementById('textBtnEditMapel' + id);
    ...
    <script>
        function openModal() {
            document.getElementById("modalMapelTambah").style.display = 'block';
        }

        function closeModal() {
            document.getElementById("modalMapelTambah").style.display = 'none';
        }

        function openModalImport() {
            document.getElementById("modalMapelImport").style.display = 'flex';
        }

        function closeModalImport() {
            document.getElementById("modalMapelImport").style.display = 'none';
        }

        function openModalExport() {
            document.getElementById("modalMapelExport").style.display = 'flex';
        }

        function closeModalExport() {
            document.getElementById("modalMapelExport").style.display = 'none';
        }
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function loadData() {
                ...
                currentRequest.open('GET', '{{ route('admin_mapel.filter') }}?' + filterData.toString(), true);
